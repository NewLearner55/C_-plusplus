...
void DataManager::DeleteDoc(const string &path, string doc)
{
	...
	//递归删除子目录
	//C:\Users\Lenovo\Desktop\C语言课件V3\进阶\my_dir
	string doc_path = path;
	doc_path += "\\";
	//C:\Users\Lenovo\Desktop\C语言课件V3\进阶\my_dir\
    doc_path += doc;
	//C:\Users\Lenovo\Desktop\C语言课件V3\进阶\my_dir\AA
	...
	string &prefix, string &hightlight, string &suffix)
{
	...
	//str = "123学好编程,xyz,让就业更简单666"; 
	//str_pinyin = "123xuehaobiancheng,xyz,rangjiuyegengjiandan666"
	//key_pinyin = "jiuye"
