...
{
	//创建扫描实例
	const string path = "C:\\Users\\Lenovo\\Desktop\\C语言课件V3\\进阶\\my_dir";
	//ScanManager sm;
...
{
	string path = "C:\\Users\\Lenovo\\Desktop\\C语言课件V3\\进阶\\my_dir";
...
{
	//创建扫描实例
	const string path = "C:\\Users\\Lenovo\\Desktop\\C语言课件V3\\进阶";
	ScanManager sm;
